...
var ptASObj = function (fld, param, id) {
 ...
 var head = document.getElementsByTagName("head")[0];  var el = document.createElement("script"); if (ptUtil.id("ptasjs1") != null && typeof(ptUtil.id("ptasjs1")) != "undefined")
 {
 el.src = ptUtil.id("ptasjs1").firstChild.data; el.type="text/javascript"; head.appendChild(el); }
 }); }
